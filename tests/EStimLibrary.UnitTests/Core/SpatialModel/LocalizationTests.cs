...
public class LocalizationDataTests
{
    ...
    {
    // Arrange
    var data1 = new LocalizationData(data1FullyContaining, data1PartiallyContaining);
    var data2 = new LocalizationData(data2FullyContaining, data2PartiallyContaining);
