...
public class StringHierarchySpecTests
{
    ...
    /// <summary>
    /// Test the method ParseFullSpec. This requires the methods 
    /// ParseRegionSpec and ParseModifierSpec to function correctly as 
    /// well. Assumes that fullspec includes regions and modifiers.
    /// </summary>
    [Theory]
