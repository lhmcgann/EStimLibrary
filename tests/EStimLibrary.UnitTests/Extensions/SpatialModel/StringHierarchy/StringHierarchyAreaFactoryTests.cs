...
public class StringHierarchyAreaFactoryTests
{
    ...
    public void Constructor_Null_ShouldError()
    {
        Assert.Throws<NullReferenceException>(() =>
        {
            ...
            StringHierarchyAreaFactory factory = new(null!);
        });
    }
    ...
    public void Constructor_NonNull_ShouldInit()
    {
        ...
        string help = "A StringHierarchyArea can be built from one of the " +
    ...
    public void TryCreate_ShouldNotValidateShouldCreate()
    {
        ...
        bool valid = factory.TryCreate(paramValues1, out IArea? product,
            skipValueValidation: true);
        Assert.True(valid);
        ...
        Dictionary<string, object> paramValues)
    {
        ...
        Assert.True(valid);
        Assert.NotNull(product);
        Assert.Equal((IArea)new StringHierarchyArea(spec), product);
    }
